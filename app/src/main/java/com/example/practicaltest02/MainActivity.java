...
public class MainActivity extends AppCompatActivity {
    ...
    private GetWeatherForecastButtonClickListener getWordDefinitionButtonClickListener = new GetWeatherForecastButtonClickListener();
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (name == null || name.isEmpty()) {
                Toast.makeText(getApplicationContext(), "[MAIN ACTIVITY] Parameter from client (name) should be filled", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), name, wordDefinitionTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wordDefinitionTextView = (TextView)findViewById(R.id.word_definition_edit_text);
    }
